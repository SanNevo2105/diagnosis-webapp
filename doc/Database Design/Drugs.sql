...
-- QUERY FOR DRUGS INFORMATION: 

-- use team059;
-- drop procedure drugs_information; 

-- delimiter //
-- create procedure drugs_information(in input_drug varchar(50), in p_explain tinyint unsigned) 
-- begin 
-- 	if (p_explain) then
-- 		explain analyze
--         
...
-- -- create index get_drugs_index1 on Drugs(name) ;
-- -- create index get_drugs_index2 on Drug_Relations (drug2) ; 
-- drop index get_drugs_index1 on Drugs;
-- call drugs_information("amikacin", 0);
...
-- QUERY FOR DRUGS REVIEWS: 

-- use team059;

-- drop procedure drugs_review; 

-- delimiter //
-- create procedure drugs_review(in input_drug varchar(50), in p_explain tinyint unsigned) 
-- begin 
-- 	if (p_explain) then
-- 		explain analyze
--         
-- 		SELECT *
-- 		FROM Drugs_Reviews
-- 		WHERE Drugs_Reviews.drugName = input_drug;
-- 	else  
-- 		SELECT *
-- 		FROM Drugs_Reviews
-- 		WHERE Drugs_Reviews.drugName = input_drug;
...
-- -- create index get_drugs_reviews_index1 on Drugs_Reviews(drugName) ;
-- -- drop index get_drugs_reviews_index1 on Drugs_Reviews;
-- call drugs_review("cephalexin", 0);


-- GET DRUGS SPECIAL_RATING: 
